...
import exchange_artifacts from '../../build/contracts/MyTokenManage.json'
import token_artifacts from '../../build/contracts/MyERC20Token.json'
...
window.App = {
    ...
    refreshBalanceExchange: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            ...
            return exchangeInstance.getBalance("HQL", {from: account});
        }).then(function (value) {
    ...
    depositToken: function () {
        ...
        App.setStatus("Initiating deposit token transaction... (please wait)");
        ExchangeContract.deployed().then(function (instance) {
            exchangeInstance = instance;
    ...
    updateOrderBooks: function () {
        ...
        ExchangeContract.deployed().then(function(instance) {
            exchangeInstance = instance;
            return exchangeInstance.getSellOrderBook("HQL");
            ...
            return exchangeInstance.getBuyOrderBook("HQL");
